...
const Layout = ({
  ...
  const wrapInHomeUrl = (element) => {
    if (currentPath === "/") return element;

    return (
      <a href="/" rel="noreferrer" className="c-nav__link" title="Home">
        {element}
      </a>
    );
  };
    ...
    <>
      ...
      >
        ...
        {!!(
          ...
          (metaData && metaData.metaTitle)
        ) && (
          <title>
            {`${
              (pageData &&
                pageData.title &&
                pageData.title !== (metaData && metaData.metaTitle) &&
                `${pageData.title} | `) ||
              ""
            }
            ${metaData.metaTitle || ""}`}
      ...
      <div className="c-body">
        ...
        {!!(metaData && metaData.footerEmbedUrl) && (
          <footer className="c-footer">
            <iframe
              title={`${(metaData && metaData.metaTitle) || ""} embed`}
